...
const AlbumControlScreen = () => {
  ...
  const actions = [
    ...
    { id: "2", title: "View artist", icon: "account-music-outline", type: "MaterialCommunityIcons" },
    { id: "3", title: "Share", icon: "share-outline" },
    { id: "4", title: "Like all songs", icon: "heart-multiple-outline", type: "MaterialCommunityIcons" },
    { id: "5", title: "Add to playlist", icon: "playlist-plus", type: "MaterialCommunityIcons" },
    { id: "6", title: "Add to queue", icon: "playlist-play", type: "MaterialCommunityIcons" },
