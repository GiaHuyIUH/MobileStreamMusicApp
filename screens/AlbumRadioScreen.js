...
const AlbumRadioScreen = () => {
  ...
  const nextTracks = [
    ...
    { id: "2", title: "Walk Like a Man", artist: "Frankie Valli & The Four Seasons" },
    { id: "3", title: "Don't Let Me Down - Remastered 2009", artist: "The Beatles" },
  ...
  const renderTrackItem = ({ item }) => (
    <TouchableOpacity onPress={() => setNowPlaying(item)} style={styles.trackItem}>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.nowPlayingContainer}>
        ...
        <View style={styles.nowPlayingInfo}>
          <Image source={{ uri: nowPlaying.cover }} style={styles.nowPlayingCover} />
