...
const AlbumViewScreen = () => {
  ...
  const tracks = [
    ...
    { id: '3', name: 'She Loves You - Mono / Remastered', artist: 'The Beatles' },
  ...
  const renderTrack = ({ item }) => (
    <TouchableOpacity onPress={() => setPlayingTrack(item)} style={styles.trackItem}>
      <View style={styles.trackInfo}>
        <Text style={[styles.trackName, playingTrack?.id === item.id && styles.playingTrack]}>{item.name}</Text>
    ...
    <SafeAreaView style={styles.container}>
        ...
        ListHeaderComponent={
          <>
            <View style={styles.albumInfoContainer}>
              ...
              <View style={styles.artistRow}>
                <Image
                  source={{ uri: 'https://upload.wikimedia.org/wikipedia/en/0/05/The_Beatles_-_Sgt._Pepper%27s_Lonely_Hearts_Club_Band.jpg' }}
      ...
      {playingTrack && (
        ...
        >
          ...
          <Ionicons name="bluetooth-outline" size={20} color="#1DB954" style={styles.bluetoothIcon} />
          <TouchableOpacity>
